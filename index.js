...
// New function to handle delivery type change
document.getElementById('deliveryType').onchange = function() {
    const deliveryTypeSelect = document.getElementById('deliveryType');
    const serviceTypeContainer = document.getElementById('radios'); // Assuming this is the container for radio buttons

    if (deliveryTypeSelect.value == 'abroad') {
        serviceTypeContainer.style.display = 'block'; // Show radio buttons
    } else {
        serviceTypeContainer.style.display = 'none'; // Hide radio buttons
    }
}
